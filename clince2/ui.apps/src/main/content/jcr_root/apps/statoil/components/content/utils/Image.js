...
use(["ResourceUtils.js", "/libs/sightly/js/3rd-party/q.js"], function (ResourceUtils, Q) {
    ...
    var CONST = {
        ...
        WEB_RENDITION_LARGE: "img.620.high",
        WEB_RENDITION_MEDIUM: "img.480.medium",
        WEB_RENDITION_SMALL: "img.320.low",
    ...
    Image.prototype.src_large = function () {
                return that.resource.path + "/_jcr_content/renditions/" +CONST.WEB_RENDITION_LARGE + "."
                        + getExtension() + getCachingSuffix();
    };
    Image.prototype.src_medium = function () {
                    return that.resource.path + "/_jcr_content/renditions/" + CONST.WEB_RENDITION_MEDIUM + "."
                            + getExtension() + getCachingSuffix();
    };
    Image.prototype.src_small = function () {
            return that.resource.path + "/_jcr_content/renditions/" + CONST.WEB_RENDITION_SMALL + "."
                    + getExtension() + getCachingSuffix();
    };
    ...
    function searchWebRendition(renditions, currentIndex, promise) {
        ...
        if (currentRendition.name.indexOf(CONST.WEB_RENDITION_PREFIX) >= 0) {
            ...
            .then(function (renditionContentResource) {
                ...
                var mimeType = renditionContentResource.properties[CONST.PROP_JCR_MIME_TYPE]
                        || defaultMimeType;
